...
- `chapters/ch06-domain-specific-accelerators.md` — Chapter 6 cornerstone draft awaiting review; eight architecture families (systolic arrays, tensor processors, deterministic dataflow/tile processors, NPUs incl. microNPU/near-sensor, FPGA/reconfigurable, wafer-scale, memory-centric/PIM, neuromorphic overview) under one template (primer, contracts, evidence anchors, envelope, continuum, §5.11 position and §2.14 risk), with master comparison Table 6.1, four prototype figures, and rich placeholders
