...
- Appendix G datacenter/mobile economic-primer draft awaiting review: `appendices/appendix-g-economic-primer.md`
...
- 2026-07-17 (later session): Chapter 6 cornerstone drafted (`chapters/ch06-domain-specific-accelerators.md`) with eight families including the newly added deterministic dataflow/tile class, per-family primers/contracts/anchors/continuum/partition-position, master comparison Table 6.1, four prototype figures, and six placeholder figures; Chapters 7 and 8 drafted (`chapters/ch07-enterprise-accelerator-landscape.md`, `chapters/ch08-client-edge-ai-landscape.md`) as architecture-organized, evidence-classed, snapshot-dated (mid-2026) landscape chapters; outline Chapter 6 family list updated in place with a dated note; Chapter 5 §5.13 family list extended; references extended for Chapters 6–8; open decisions and verification requests recorded in `discussions/questions_for_author_2026-07-17.md`. All await user review.
